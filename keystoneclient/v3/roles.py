...
class RoleManager(base.CrudManager):
    ...
    def _require_domain_or_project(self, domain, project):
        if (domain and project) or (not domain and not project):
            raise Exception('Specify either a domain or project, not both')
    ...
    def grant(self, role=None, user=None, domain=None, project=None):
    ...
    def check(self, role=None, user=None, domain=None, project=None):
        """Grants a role to a user on either a domain or project."""
        self._require_domain_or_project(domain, project)
    ...
    def revoke(self, role=None, user=None, domain=None, project=None):
